...
import { Moon, Sparkles, Cloud, Github, Twitter, Linkedin } from 'lucide-react';
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-purple-950 flex flex-col relative overflow-hidden">
      {/* Background Elements */}
      ...
      {/* Main Content Area - flex-1 ensures it takes available space and centers content */}
              ...
              <>
                ...
                <div className="space-y-3 text-center">
                  <button
                    ...
                    className="text-purple-600 hover:text-purple-700 font-medium transition-colors block w-full"
                  >
                  ...
                  {!isSignUp && (
                    <button
                      ...
                      className="text-purple-600 hover:text-purple-700 font-medium transition-colors block w-full text-sm"
                    >
      ...
      {/* Footer Section */}
      <footer className="relative z-10 w-full bg-purple-950 bg-opacity-50 border-t border-purple-800 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="text-purple-300 text-sm">
              &copy; {new Date().getFullYear()} DreamCatcher. All rights reserved.
            </div>
